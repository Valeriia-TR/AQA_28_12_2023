...
def test_bypass_main_to_roborock_pylesos(main_page):
    robot_page = main_page.robot_pylesos_category()
    robot_page.click_filter_checkbox_roborock()
    assert robot_page.text_of_selected_type_filter() == "Бренд: Roborock"